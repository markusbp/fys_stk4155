...
def get_parameters():
    ...
    parser.add_argument('--train_steps', default = int(1e3), help = 'Number of training steps',type = int)
    ...
    parser.add_argument('--output_activation', default = 'linear', help = 'Output activation function')
